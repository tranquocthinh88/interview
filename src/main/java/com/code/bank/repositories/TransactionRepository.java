...
public interface TransactionRepository extends BaseRepository<Transaction, String> {
    ...
    long countTransactionByDay(@Param("date") LocalDateTime date, @Param("transactionType")TransactionType transactionType);
    ...
    long countTransactionByWeek(@Param("startDate") LocalDateTime startDate, @Param("endDate")LocalDateTime endDate, @Param("transactionType")TransactionType transactionType);
